...
| Campo | Valor |
| --- | --- |
| Historia | **AURA-55** — Módulo Paciente - Aurora Care |
...
> [!todo] Derivar de la descripción del ticket en Jira (AURA-55).
- [ ] {criterio_1}
- [ ] {criterio_2}
...
| --- | --- | --- | --- | --- |
| CP-AURA-55-01 | {precondición} | {pasos} | {esperado} | Pendiente |
