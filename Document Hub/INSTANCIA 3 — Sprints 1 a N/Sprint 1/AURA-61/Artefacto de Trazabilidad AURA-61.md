...
---
# Artefacto de Trazabilidad — AURA-61 Vistas Recordatorio UI
...
| Campo | Valor |
| --- | --- |
| Historia | **AURA-61** — Vistas Recordatorio UI |
...
| Enlace | https://project-aurora-alz.atlassian.net/browse/AURA-61 |

## 1. Historia de usuario
> [!todo] **Como** {rol} **quiero** {objetivo} **para** {beneficio}.

### Criterios de aceptación
> [!todo] Derivar de la descripción del ticket en Jira (AURA-61).
- [ ] {criterio_1}
- [ ] {criterio_2}
...
| --- | --- | --- | --- | --- |
| CP-AURA-61-01 | {precondición} | {pasos} | {esperado} | Pendiente |
