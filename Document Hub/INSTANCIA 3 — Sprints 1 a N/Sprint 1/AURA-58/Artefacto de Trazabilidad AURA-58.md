...
---
# Artefacto de Trazabilidad — AURA-58 Módulo Recetario
...
| Campo | Valor |
| --- | --- |
| Historia | **AURA-58** — Módulo Recetario |
...
> [!todo] Derivar de la descripción del ticket en Jira (AURA-58).
- [ ] {criterio_1}
- [ ] {criterio_2}
...
| --- | --- | --- | --- | --- |
| CP-AURA-58-01 | {precondición} | {pasos} | {esperado} | Pendiente |
