...
---
# Artefacto de Trazabilidad — AURA-56 Módulo Terapias Cognitivas
...
| Campo | Valor |
| --- | --- |
| Historia | **AURA-56** — Módulo Terapias Cognitivas |
...
> [!todo] Derivar de la descripción del ticket en Jira (AURA-56).
- [ ] {criterio_1}
- [ ] {criterio_2}
...
| --- | --- | --- | --- | --- |
| CP-AURA-56-01 | {precondición} | {pasos} | {esperado} | Pendiente |
