...
---
# Artefacto de Trazabilidad — AURA-60 Vistas Terapias UI
...
| Campo | Valor |
| --- | --- |
| Historia | **AURA-60** — Vistas Terapias UI |
...
| Enlace | https://project-aurora-alz.atlassian.net/browse/AURA-60 |

## 1. Historia de usuario
> [!todo] **Como** {rol} **quiero** {objetivo} **para** {beneficio}.

### Criterios de aceptación
> [!todo] Derivar de la descripción del ticket en Jira (AURA-60).
- [ ] {criterio_1}
- [ ] {criterio_2}
...
| --- | --- | --- | --- | --- |
| CP-AURA-60-01 | {precondición} | {pasos} | {esperado} | Pendiente |
