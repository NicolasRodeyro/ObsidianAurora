...
---
# Artefacto de Trazabilidad — AURA-90 AH-M01 — Base inicial del repositorio Aurora Home
...
| Campo | Valor |
| --- | --- |
| Historia | **AURA-90** — AH-M01 — Base inicial del repositorio Aurora Home |
...
| Enlace | https://project-aurora-alz.atlassian.net/browse/AURA-90 |

## 1. Historia de usuario
> [!todo] **Como** {rol} **quiero** {objetivo} **para** {beneficio}.

### Criterios de aceptación
> [!todo] Derivar de la descripción del ticket en Jira (AURA-90).
- [ ] {criterio_1}
- [ ] {criterio_2}
...
| --- | --- |
| Aurora Home | Repo `AuroraHome` — estructura base del proyecto |
...
| --- | --- | --- | --- | --- |
| CP-AURA-90-01 | {precondición} | {pasos} | {esperado} | Pendiente |
