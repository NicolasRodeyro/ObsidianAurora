...
| Campo | Valor |
| --- | --- |
| Historia | **AURA-54** — Login - Aurora Care |
...
> [!todo] Derivar de la descripción del ticket en Jira (AURA-54).
- [ ] {criterio_1}
- [ ] {criterio_2}
...
| --- | --- | --- | --- | --- |
| CP-AURA-54-01 | {precondición} | {pasos} | {esperado} | Pendiente |
