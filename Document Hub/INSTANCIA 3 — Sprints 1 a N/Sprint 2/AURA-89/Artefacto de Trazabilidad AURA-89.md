...
---
# Artefacto de Trazabilidad — AURA-89 API REST: Registro de Cumplimiento de Rutinas y Medicación
...
| Campo | Valor |
| --- | --- |
| Historia | **AURA-89** — API REST: Registro de Cumplimiento de Rutinas y Medicación |
...
> [!todo] Derivar de la descripción del ticket en Jira (AURA-89).
- [ ] {criterio_1}
- [ ] {criterio_2}
...
| --- | --- |
| Backend | Repo `AuroraCareBack` — `apps/routines/` (compliance) |
| Tests | `apps/routines/tests/test_compliance_api.py` |
...
| --- | --- | --- | --- | --- |
| CP-AURA-89-01 | {precondición} | {pasos} | {esperado} | Pendiente |
