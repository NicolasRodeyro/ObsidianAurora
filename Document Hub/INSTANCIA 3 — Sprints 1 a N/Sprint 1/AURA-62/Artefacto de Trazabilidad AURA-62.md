...
---
# Artefacto de Trazabilidad — AURA-62 Vistas Recetario UI
...
| Campo | Valor |
| --- | --- |
| Historia | **AURA-62** — Vistas Recetario UI |
...
| Enlace | https://project-aurora-alz.atlassian.net/browse/AURA-62 |

## 1. Historia de usuario
> [!todo] **Como** {rol} **quiero** {objetivo} **para** {beneficio}.

### Criterios de aceptación
> [!todo] Derivar de la descripción del ticket en Jira (AURA-62).
- [ ] {criterio_1}
- [ ] {criterio_2}
...
| --- | --- | --- | --- | --- |
| CP-AURA-62-01 | {precondición} | {pasos} | {esperado} | Pendiente |
