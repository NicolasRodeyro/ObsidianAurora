...
---
# Artefacto de Trazabilidad — AURA-57 Módulo Recordatorios
...
| Campo | Valor |
| --- | --- |
| Historia | **AURA-57** — Módulo Recordatorios |
...
> [!todo] Derivar de la descripción del ticket en Jira (AURA-57).
- [ ] {criterio_1}
- [ ] {criterio_2}
...
| --- | --- | --- | --- | --- |
| CP-AURA-57-01 | {precondición} | {pasos} | {esperado} | Pendiente |
