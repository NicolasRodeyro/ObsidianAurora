...
---
# Artefacto de Trazabilidad — AURA-91 AH-M02 — Contratos v1 y simulador local Home-Core
...
| Campo | Valor |
| --- | --- |
| Historia | **AURA-91** — AH-M02 — Contratos v1 y simulador local Home-Core |
...
| Enlace | https://project-aurora-alz.atlassian.net/browse/AURA-91 |

## 1. Historia de usuario
> [!todo] **Como** {rol} **quiero** {objetivo} **para** {beneficio}.

### Criterios de aceptación
> [!todo] Derivar de la descripción del ticket en Jira (AURA-91).
- [ ] {criterio_1}
- [ ] {criterio_2}
...
| --- | --- |
| Aurora Home | Repo `AuroraHome` — `src/aurora_home/contracts/`, `src/aurora_home/simulator/` |
...
| --- | --- | --- | --- | --- |
| CP-AURA-91-01 | {precondición} | {pasos} | {esperado} | Pendiente |
