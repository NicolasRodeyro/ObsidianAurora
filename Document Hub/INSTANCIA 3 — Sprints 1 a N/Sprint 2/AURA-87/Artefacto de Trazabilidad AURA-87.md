...
---
# Artefacto de Trazabilidad — AURA-87 API REST: CRUD de Rutinas del Paciente
...
> [!todo] Derivar de la descripción del ticket en Jira (AURA-87).
- [ ] {criterio_1}
- [ ] {criterio_2}
...
| --- | --- |
| Backend | Repo `AuroraCareBack` — `apps/routines/` (views, serializers, `nested_urls.py`) |
| Tests | `apps/routines/tests/test_routine_create_api.py` |
...
| --- | --- | --- | --- | --- |
| CP-AURA-87-01 | {precondición} | {pasos} | {esperado} | Pendiente |
