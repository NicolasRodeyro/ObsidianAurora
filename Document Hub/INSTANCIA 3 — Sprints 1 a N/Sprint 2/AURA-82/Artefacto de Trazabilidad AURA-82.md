...
---
# Artefacto de Trazabilidad — AURA-82 Integración Auth0: autenticación JWT en AuroraCore
...
| Requerimientos | RF-76–81 (ver [[Requerimientos]] · [[Trazabilidad RF-Épicas]]) |
...
> [!todo] Derivar de la descripción del ticket en Jira (AURA-82).
- [ ] {criterio_1}
- [ ] {criterio_2}
...
| --- | --- |
| Backend | Repo `AuroraCareBack` — `apps/common/auth0.py` (validación JWT RS256 contra JWKS) |
| Config | `config/urls.py`, `config/settings/production.py` |
...
| --- | --- | --- | --- | --- |
| CP-AURA-82-01 | {precondición} | {pasos} | {esperado} | Pendiente |
